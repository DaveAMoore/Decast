...
internal class DictionaryDecoder: Decoder {
    ...
    internal init(container: Any, codingPath: [CodingKey] = []) {
...
extension DictionaryDecoder {
    internal func decode<T : Decodable>(_ type: T.Type, from container: Any) throws -> T {
        storage.push(container: container)
